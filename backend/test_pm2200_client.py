#!/usr/bin/env python3
"""
Tests for PM2200 Modbus Scanner (pm2200_client.py)
Tests for PM2200Scanner class methods with mocked serial connection
"""
...
def mock_serial_client():
    ...
    with patch("pm2200_client.ModbusSerialClient") as mock:
        yield mock


@pytest.fixture
def scanner(mock_serial_client):
    """Create a PM2200Scanner instance with mocked serial."""
    mock_instance = mock_serial_client.return_value
    mock_instance.connect.return_value = True
    mock_instance.isError.return_value = False

    scanner = PM2200Scanner(port="COM3", baudrate=9600, slave_id=1, parity="E")
...
# ============================================================================
# Tests for PM2200Scanner Initialization
# ============================================================================
class TestPM2200ScannerInit:
    """Tests for PM2200Scanner initialization."""

    def test_init_default_values(self, mock_serial_client):
        """Test initialization with default values."""
        scanner = PM2200Scanner()
...
# ============================================================================
# Tests for PM2200Client Wrapper
# ============================================================================
class TestPM2200ClientWrapper:
    """Tests for PM2200Client wrapper class."""

    def test_client_init(self, mock_serial_client):
        """Test PM2200Client initialization."""
        client = PM2200Client(port="COM5", baudrate=19200, slave_id=3, parity="N")
...
class TestIntegration:
    ...
    def test_scanner_class_workflow(self, mock_serial_client):
        """Test PM2200Scanner class workflow."""
        mock_instance = mock_serial_client.return_value
        mock_instance.connect.return_value = True
        mock_instance.isError.return_value = False
        mock_instance.registers = [0x4366, 0x0000]

        scanner = PM2200Scanner(port="COM3")
        scanner.connect()
