...
const API_BASE = process.env.PM2200_API_BASE || 'http://localhost:8002';
const OUTPUT_FILE = process.env.PM2200_REPORT_OUTPUT || path.join(process.cwd(), 'public', 'report-template-live.svg');
const WIDTH = 1240;
const HEIGHT = 1754;
...
<svg xmlns="http://www.w3.org/2000/svg" width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}" role="img" aria-label="PM2200 Dynamic One-Page Report">
  <defs>
  ...
  <g transform="translate(58,56)">
    ...
    <text class="h1" x="30" y="66">PM2200 Dynamic Report (Auto Analysis)</text>
  ...
  <g transform="translate(58,1280)">
    ...
    <text class="mono" x="744" y="312">Template: PM2200-DYNAMIC-A4-v1</text>
